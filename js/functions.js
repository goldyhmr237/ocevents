                                        ...
                                        success: function(DtatURL) {
                                            ...
                                            b.download_file(DtatURL, DIR_Name + '/', image_name, function(theFile) {
                                                ...
                                                descr = descr.replace(/'/g, "\\");
                                                    //alert(descr);
                                                    tx.executeSql("insert into OCEVENTS_agenda (group_title,user_id,agenda_id,event_id,title,speaker_name,speaker_image,start_time,end_time,embeded_html,event_time) values ('"+val.group_title+"','" + localStorage.user_id + "','" + val1.id + "','" + val1.event_id + "','" + val1.title + "','" + val1.speaker_name + "','" + ImgFullUrl + "','" + val1.start_time + "','" + val1.end_time + "','" + val1.embeded_html + "','" + val1.time + "')");
